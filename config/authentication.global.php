    ...
    'authentication' => [
        ...
        'security' => [ //- An array for our security features.
            ...
            'table_override' => [ // - An array, in which we define routes and their database-table prefix that the system will use tot check if they start with the key of any entry.
                'user'  => ['tableKey' => 'user', 'display' => 'Benutzer', 'loginAt' => 'userLogin'], // Routename starts with 'user' => use table prefix 'user' : user - for base table, user_permissions for all permissions that only user_groups can have, etc.
                'admin' => ['tableKey' => 'admin', 'display' => 'Admin', 'loginAt' => 'adminLogin'],
            ],
        ]
    ],
